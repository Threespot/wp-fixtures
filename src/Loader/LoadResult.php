 ...
 *
 * Each loader (PageLoader, TaxonomyLoader, FormLoader) returns one of these;
 * FixturesCommand merges them together to produce a single end-of-run summary.
 *
 * Three buckets:
...
{
    /** @var list<array{path?:string,file?:string,slug?:string,taxonomy?:string,post_id?:int,term_id?:int}> */
    public array $created = [];

    /** @var list<array{path?:string,file?:string,slug?:string,taxonomy?:string,post_id?:int,term_id?:int}> */
    public array $skipped = [];

    /** @var list<array{path?:string,file?:string,slug?:string,taxonomy?:string,error:string}> */
    public array $errors = [];

    /**
     * Concatenates another result's rows into this one.
     *
     * Used by FixturesCommand to roll per-section results (taxonomies, forms,
     * pages) into a single total for the run summary.
     */
